...
public class OffsetStatus_ToggleSwitch extends Parent {
    ...
    public OffsetStatus_ToggleSwitch(boolean defaultSwitched, EstablishOrder_Controller EstablishOrder_Controller){
    ...
    public void setSwitchedOnStatus(boolean isOn){
        ...
        animation.play();
        if(isOn){
            EstablishOrder_Controller.OffsetOrder_CheckBox.setText("全 冲 帳");
        }else{
            EstablishOrder_Controller.OffsetOrder_CheckBox.setText("部分冲帳");
        }
    }
}
